package com.lind.lib_base.uibase.base
...
import com.lind.lib_base.R
import com.lind.lib_base.uibase.inner.IBaseView
import com.lind.lib_base.uibase.inner.OnToolBarClickListener
import com.lind.lib_base.uibase.viewmodel.BaseActivity
import com.lind.lib_base.uibase.viewmodel.BaseViewModel
import com.lind.lib_base.utils.FragmentStarter
...
abstract class BaseWonderFragment<VM : BaseViewModel, VB : ViewBinding> : Fragment(), IBaseView,
    ...
    open fun initImmersionBar() {
        ...
        val baseActivity = getBaseActivity() as AgedBaseActivity<*, *>
        if (enabledVisibleToolBar()) {
    ...
    override fun onBackPressed() {
        try {
            if (getBaseActivity() != null) {
                if (getBaseActivity() is AgedBaseActivity<*, *>) {
